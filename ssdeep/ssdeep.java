    ...
    private long score_strings(byte[] s1, byte[] s2, long block_size)
    {
        ...
        if (len1 > SPAMSUM_LENGTH || len2 > SPAMSUM_LENGTH)
        {
            /* not a real spamsum signature? */
             System.out.println("not a real spamsum signature");
            return 0;
        }
        ...
        {
            System.out.println("the two strings must have a common substring of length");
            return 0;
        }*/
        ...
        System.out.println("edit_distn:"+score);
        ...
        if (score >= 100)
        {
            System.out.println("it is possible to get a score above 100 here, but it is a really terrible match");
                return 0;
        }
